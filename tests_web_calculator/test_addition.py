...
def test_addition_numbers(random_data_for_request: dict, rout_addition: str, get_date_time: str):
    ...
    if isinstance(x, int) and isinstance(y, int):
        expect_result = x + y
    with requests.post(rout_addition, data=json.dumps(data)) as response:
