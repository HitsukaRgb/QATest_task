...
def test_remainder_numbers(random_data_for_request: dict, rout_remainder: str, get_date_time: str):
    """Тестирование функции остатка от деления"""
    ...
    if isinstance(x, int) and isinstance(y, int):
        try:
            ...
            pass
    with requests.post(rout_remainder, data=json.dumps(data)) as response:
